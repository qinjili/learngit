...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="BillServlet?sign=billAdd">
			...
			<table class="box">
			   ...
			   <tr>
				 ...
				 <tr>
					...
					<td><input type="radio" name="payed" value="2">是<input type="radio" name="payed" checked="checked" value="1">否</td>
				</tr>
			</tbody></table>
		</div>
		<div class="buttons">
